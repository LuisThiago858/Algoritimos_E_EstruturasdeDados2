...
//        inserir_inicio_lse(musicas, i);
    ...
    char minha_musica2[60];
    while(strcmp(minha_musica2,"FIM")!=0){
        scanf("%s", minha_musica2);
        m = remover_lse(musicas, minha_musica2);
        if (m){
